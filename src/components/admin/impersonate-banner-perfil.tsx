...
export function ImpersonateBannerPerfil() {
  ...
  useEffect(() => {
    ...
    if (email) {
      setImpersonating({ email, name: name || email });
    }
  }, []);
  ...
  return (
    <div className="rounded-xl bg-gradient-to-r from-violet-600 via-purple-600 to-rose-500 text-white px-4 py-3 flex items-center justify-between">
