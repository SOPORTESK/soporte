...
export const COMPLETE_MODULE_DEFINITIONS: ModuleDef[] = [
  {
    ...
    desc: "Monitoreo en tiempo real de colaboradores, apps, capturas, agenda y control de Activity Tracker",
    subcategories: [
      ...
      { key: "agenda_calendario", label: "Agenda & Calendario de Tareas (/agenda)", desc: "Visibilidad de pestaña de agenda en la barra lateral y acceso al calendario y lista de tareas" },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: "analitica_equipos_fallas", label: "Analítica de Equipos & Fallas Frecuentes", desc: "Métricas por marca, modelo y árbol de diagnósticos frecuentes (/admin/estadisticas)" },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: "edge_functions_status", label: "Monitor de Infraestructura & Edge Functions", desc: "Verificación de estado de funciones serverless activas (Gemini, Webhooks, Auto-close, Learn)" },
