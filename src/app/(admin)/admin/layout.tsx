            ...
            <div className="relative px-5 py-5 border-b border-border gradient-brand text-white overflow-hidden">
              ...
              <div className="relative flex items-center gap-3">
                <div className="relative group/logo">
                  <div className="absolute -inset-1 bg-gradient-to-r from-white/40 via-blue-400/40 to-orange-400/40 rounded-2xl blur opacity-60 group-hover/logo:opacity-80 transition duration-500" />
                  <div className="relative w-11 h-11 rounded-xl bg-white/10 backdrop-blur-md p-0.5 shadow-2xl shadow-black/30 border border-white/20 group-hover:scale-105 transition-all duration-300">
                    <div className="w-full h-full rounded-[10px] bg-slate-950/50 flex items-center justify-center overflow-hidden">
                      <Image src="/logoTienda3D.png" alt="Sekunet" width={40} height={40} className="object-contain drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]" />
                    </div>
                  </div>
                </div>
